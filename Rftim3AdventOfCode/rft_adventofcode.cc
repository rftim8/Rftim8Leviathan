...
//     rft_adventofcode_csv aoc_csv;
//     aoc_csv.competition_name = "AdventOfCode_2022";
//     aoc_csv.rank = 0;
//     aoc_csv.rating = 0;
//     aoc_csv.problem_number = "aoc_00000001_Y22";
//     aoc_csv.problem_title = "Calorie Counting";
//     aoc_csv.problem_description = R"(
...
//     aoc_csv.problem_input = R"(1
// 1
// 595
// 80598)";
//     aoc_csv.difficulty = 0;
//     aoc_csv.algorithms = {""};
//     insertPGAdventOfCodeFullProblem(aoc_csv);

    printAdventOfCodeProblem(getPGAdventOfCodeProblem("aoc_00000001_Y22"));
